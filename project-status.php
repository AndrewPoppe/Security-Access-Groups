                    ...
                    <tr data-user="<?= $user ?>" data-email="<?= $thisUsersRights["email"] ?>"
                        ...
                        <td class="align-middle text-center">
                            <?php if ( $thisUsersRights["system_role"] ) { ?>
                                ...
                                </strong> <span>(<span class="user-select-all"><?= $thisUsersRights["system_role"] ?></span>)</span>
                            <?php } else { ?>
                        ...
                        <td class="align-middle text-center">
                            <?php if ( $thisUsersRights["project_role"] ) { ?>
                                ...
                                </strong> <span>(<span class="user-select-all"><?= $thisUsersRights["project_role"] ?></span>)</span>
                            <?php } else { ?>
                                <span class="text-secondary">None</span>
                            <?php } ?>
                        </td>
