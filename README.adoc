...
* <span class="color-fg-success">green</span> - compliant with their SAG
...
* [x] When a user is added to a project with custom rights
* [x] When a user is added to a project in an existing User Role
* [x] When a user's rights are changed
* [x] When a role's rights definition is changed
* [x] When a user is added/removed from a user role
* [x] When users are imported into a project via CSV
* [x] When a user's rights are changed via CSV import
* [x] When roles are imported into a project via CSV
* [x] When a user is assigned to a role via CSV import
* [x] When a user is added to a project via the API
* [x] When a user's rights are changed via the API
* [x] When user roles are imported/changed via the API
* [x] When a user is assigned to a role via the API
