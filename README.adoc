...
| PHP v7.4.5
| image:https://github.com/AndrewPoppe/Security-Access-Groups/actions/workflows/playwright_PHP7.4.5_REDCap13.7.23.yml/badge.svg[link="https://github.com/AndrewPoppe/Security-Access-Groups/actions/workflows/playwright_PHP7.4.5_REDCap13.7.23.yml"]
...
| image:https://github.com/AndrewPoppe/Security-Access-Groups/actions/workflows/playwright_PHP7.4.5_REDCap13.10.0.yml/badge.svg[link="https://github.com/AndrewPoppe/Security-Access-Groups/actions/workflows/playwright_PHP7.4.5_REDCap13.10.0.yml"]
| image:https://github.com/AndrewPoppe/Security-Access-Groups/actions/workflows/playwright_PHP7.4.5_REDCap13.11.4.yml/badge.svg[link="https://github.com/AndrewPoppe/Security-Access-Groups/actions/workflows/playwright_PHP7.4.5_REDCap13.11.4.yml"]

| PHP v8.2
| image:https://github.com/AndrewPoppe/Security-Access-Groups/actions/workflows/playwright_PHP8.2_REDCap13.7.23.yml/badge.svg[link="https://github.com/AndrewPoppe/Security-Access-Groups/actions/workflows/playwright_PHP8.2_REDCap13.7.23.yml"]
...
| image:https://github.com/AndrewPoppe/Security-Access-Groups/actions/workflows/playwright_PHP8.2_REDCap13.10.0.yml/badge.svg[link="https://github.com/AndrewPoppe/Security-Access-Groups/actions/workflows/playwright_PHP8.2_REDCap13.10.0.yml"]
| image:https://github.com/AndrewPoppe/Security-Access-Groups/actions/workflows/playwright_PHP8.2_REDCap13.11.4.yml/badge.svg[link="https://github.com/AndrewPoppe/Security-Access-Groups/actions/workflows/playwright_PHP8.2_REDCap13.11.4.yml"]
...
|1.0.4
|2023-11-29
a| * **Bug Fix**: On newer versions of REDCap that use TinyMCE version 6, the user notification email popups were not loading TinyMCE fully, resulting in reduced functionality. This has been fixed.
...
|1.0.3
|2023-10-19
a| * **Minor Bug Fix**: Fixed a bug in which the module may throw numerous unnecessary warning messages in the php log under certain conditions
* **Bug Fix**: Fixed an issue in which font files were being incorrectly loaded

|1.0.2
|2023-10-06
a| * **Major Bug Fix**: Fixed a bug in which the module failed to prevent a user from being added to a user role under certain conditions (Bug https://github.com/AndrewPoppe/Security-Access-Groups/issues/51[#51]).
* **Medium Bug Fix**: Fixed a bug in which the module failed to log role information completely under certain conditions (Bug https://github.com/AndrewPoppe/Security-Access-Groups/issues/50[#50]).
