...
@font-face {
    ...
    src: url("fonts/JetBrains-Mono/JetBrainsMono/fonts/webfonts/JetBrainsMono-Regular.woff2") format("woff2"),
        url("fonts/JetBrains-Mono/JetBrainsMono/fonts/webfonts/JetBrainsMono-Regular.woff") format("woff");
    font-weight: normal;
    font-style: normal;
}
...
@font-face {
    font-family: "JetBrains Mono";
    src: url("fonts/JetBrains-Mono/JetBrainsMono/fonts/webfonts/JetBrainsMono-Bold.woff2") format("woff2"),
        url("fonts/JetBrains-Mono/JetBrainsMono/fonts/webfonts/JetBrainsMono-Bold.woff") format("woff");
    font-weight: bold;
    font-style: normal;
}
...
@font-face {
    font-family: "JetBrains Mono";
    src: url("fonts/JetBrains-Mono/JetBrainsMono/fonts/webfonts/JetBrainsMono-Italic.woff2") format("woff2"),
        url("fonts/JetBrains-Mono/JetBrainsMono/fonts/webfonts/JetBrainsMono-Italic.woff") format("woff");
    font-weight: normal;
    font-style: italic;
}
...
@font-face {
    font-family: "JetBrains Mono";
    src: url("fonts/JetBrains-Mono/JetBrainsMono/fonts/webfonts/JetBrainsMono-BoldItalic.woff2") format("woff2"),
        url("fonts/JetBrains-Mono/JetBrainsMono/fonts/webfonts/JetBrainsMono-BoldItalic.woff") format("woff");
    font-weight: bold;
    font-style: italic;
}
