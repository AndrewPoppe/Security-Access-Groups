...
TIP: You can filter based on project status by including "project_status=" and then the status you want to filter on. For example, to only include projects that are active, you would use "project_status=Production". To only include projects that are Completed, you would use "project_status=Completed". To include both Production and Development projects, you would use "project_status=Production | project_status=Development".
