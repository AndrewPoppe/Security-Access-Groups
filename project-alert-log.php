                ...
                data: function (row, type, set, meta) {
                    ...
                    if (type === 'display') {
                        ...
                        for (let user of users) {
                            result.push(
                                `<strong><a rel="noreferrer noopener" target="_blank" href="${app_path_webroot_full + app_path_webroot + 'ControlCenter/view_users.php?username=' + user}">${user}</a></strong>`
                            );
                        }
