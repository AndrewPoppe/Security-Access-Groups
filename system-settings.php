...
<div class="SAG_Container">
    ...
    <p style='margin:20px 0;max-width:1000px;'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc velit
        ...
        at auctor volutpat, urna odio ornare nulla, a ultrices neque massa s<?php
...
?>
    ...
    <p style='max-width:700px; margin-bottom:0;'>Security Access Groups (SAGs) are used to restrict which user rights a
        REDCap user can be granted in a project. SAGs do not define the rights a user will have in a given project;
        rather,
        they define the set of allowable rights the user is able to be granted. The Security Access Groups module must
        be
    ...
    <div class="SAG_Container">
        ...
        <p style='margin:20px 0;max-width:700px;'>This table shows all users in the REDCap system and their current SAG
            assignment. Use the <span class="bg-danger text-white px-2 py-1 badge font-weight-normal"><i
                    class="fa-sharp fa-user-pen"></i>&nbsp;Edit Users</span> button to change a user's SAG assignment.
            You may export the current list of SAG assignments or import a CSV file of assignments using the buttons
            below.
        </p>
                    ...
                    <div class="d-flex dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" onclick="importCsv();"><i
                                        class="fa-sharp fa-solid fa-file-arrow-up fa-fw mr-1 text-danger"></i>Import
                                    User
                                    Assignments</a></li>
                            <li><a class="dropdown-item" onclick="downloadTemplate();"><i
                                        class="fa-sharp fa-solid fa-download fa-fw mr-1 text-primary"></i>Download
                                    Import
                                    Template</a></li>
                        </ul>
                    </div>
        ...
        <p style='margin:20px 0;max-width:700px;'>This table shows all the SAGs that currently exist in the system. A
            SAG
            ...
            const table = $('#sagTable').DataTable({
                ...
                initComplete: function() {
                    ...
                    table.on('row-reordered', function(e, diff, edit) {
                        setTimeout(() => {
                            const order = table.column(2).data().toArray();
                            localStorage.setItem('DataTables_sagOrder', JSON
                                .stringify(
                                    order));
                        }, 0);
                    });
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        data: function(row, type, set, meta) {
                            if (type === 'display') {
                                ...
                                const cellValue = [api_export, api_import].filter(el => el)
                                    .join(
                                        "<br/>");
                                return cellValue || x;
                            } else {
                    ...
                    },
                    {
                        ...
                        data: function(row, type, set, meta) {
                            if (type === 'display') {
                                return row.permissions.realtime_webservice_adjudicate ? check :
                                    x;
                            } else {
    ...
    ?>
    </div> <!-- End SAG_Container -->ed est. Vestibulum dignissim feugiat turpis
