...
class Alerts
{
    ...
    public function getAlerts($project_id = null)
    {
        ...
        $sql    = "SELECT log_id, timestamp, message 'Type', user, users, alertType 'Alert Type', recipient, recipientAddress, reminderDate, fromEmail, emailBody, emailSubject  WHERE message IN ('ALERT', 'REMINDER') AND project_id = ?";
        $params = [ $project_id ];
