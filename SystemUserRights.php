...
?>
    ...
    ?><div id="edit_role_popup">
            <div style="text-align:center; margin: 15px 0;" class="fs14 alert <?= $newRole ? "alert-primary" : "alert-success" ?>">
                <i class="fas fa-user-tag"></i> <?= $context_message ?>
            </div>
